...
const initialEvents: Event[] = [
  {
    ...
    startDateTime: new Date(new Date(new Date().setDate(new Date().getDate() + 30)).setHours(10, 0, 0, 0)),
    endDateTime: new Date(new Date(new Date().setDate(new Date().getDate() + 30)).setHours(12, 0, 0, 0)),
    capacity: 50,
    registered: [],
    queue: [],
  },
  {
    ...
    startDateTime: new Date(new Date(new Date().setDate(new Date().getDate() + 7)).setHours(12, 0, 0, 0)),
    endDateTime: new Date(new Date(new Date().setDate(new Date().getDate() + 7)).setHours(15, 0, 0, 0)),
    capacity: 15,
    registered: [],
    queue: [],
  }
